...
class RouteDescriptionViewController: UIViewController, MKMapViewDelegate {
  ...
  var route: Route!
  //Black circle in a middle of map view.
  ...
  // MARK: - @IBAction
  @IBAction func joinTapped(_ sender: UIBarButtonItem) {
  ...
  func mapView(_ mapView: MKMapView, rendererFor overlay: MKOverlay) -> MKOverlayRenderer {
    ...
    renderer.strokeColor = #colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1)
